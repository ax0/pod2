...
use super::jubjubfield::{CircuitBuilderJubjubField, JubjubFieldTarget};
...
mod tests {
    ...
    use super::super::biguint::CircuitBuilderBiguint;
    use super::{CircuitBuilderJubjubCurve, JubjubCurveTarget};
