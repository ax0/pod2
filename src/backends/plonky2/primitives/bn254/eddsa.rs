...
use super::jubjubcurve::{CircuitBuilderJubjubCurve, JubjubCurveTarget};
...
mod tests {
    ...
    use super::super::biguint::{BigUintTarget, CircuitBuilderBiguint};
    use super::{
        EddsaBuilder, EddsaPublicKeyTarget, EddsaSignatureTarget, MessageHashTarget,
        PoseidonOutputTarget,
    };
    use super::super::jubjubcurve::{CircuitBuilderJubjubCurve, JubjubCurveTarget};
    use super::super::jubjubfield::{CircuitBuilderJubjubField, JubjubFieldTarget};
